...
FramelessWindow::WhichEdge FramelessWindowPrivate::CursorPosCalculator(const QPoint &mousePos,
																	   const QRect &frameRect) const
{
...
void FramelessWindow::mousePressEvent(QMouseEvent *event)
{
	...
	if (event->button() == Qt::MouseButton::LeftButton) {
		d->whichEdge = d->CursorPosCalculator(event->globalPos(), this->frameGeometry());
